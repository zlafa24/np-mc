...
dumpfile = os.path.abspath('./sing_branched_out.xyz')
temp=298.15

sim = simc.Simulation(init_file,datafile,dumpfile,temp,anchortype=4,max_disp=5.0,type_lengths=(9),parallel=False)
