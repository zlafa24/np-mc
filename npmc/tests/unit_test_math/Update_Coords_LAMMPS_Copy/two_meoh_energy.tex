...
\begin{alltt}
  \hlstd{interm_energies} \hlkwb{=} \hlkwd{mapply}\hlstd{(energy,atom_combos[,distances}\hlopt{>=}\hlnum{5}\hlstd{][}\hlnum{1}\hlstd{,],atom_combos[,distances}\hlopt{>=}\hlnum{5}\hlstd{][}\hlnum{2}\hlstd{,])}
  \hlstd{vdw_energy} \hlkwb{=} \hlkwd{sum}\hlstd{(interm_energies)}\hlopt{+}\hlnum{2}\hlopt{*-}\hlnum{0.1406}
  \hlkwd{print}\hlstd{(interm_energies)}
\end{alltt}
\begin{verbatim}
##  [1] -0.17543077 -0.04574351 -0.06066907 -0.01568413  0.00000000
##  [6] -0.04574351 -0.03314609 -0.02783789 -0.01612032  0.00000000
## [11] -0.06066907 -0.02783789 -0.03314609 -0.01220641  0.00000000
## [16] -0.01568413 -0.01612032 -0.01220641 -0.00908311  0.00000000
## [21]  0.00000000  0.00000000  0.00000000  0.00000000  0.00000000
\end{verbatim}
\begin{alltt}
  \hlkwd{sprintf}\hlstd{(}\hlstr{"Total intermolecular Van der Waals Energy is: %4.8f kcal/mol"}\hlstd{,}\hlkwd{sum}\hlstd{(interm_energies))}
\end{alltt}
\begin{verbatim}
## [1] "Total intermolecular Van der Waals Energy is: -0.60732869 kcal/mol"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
##  [1] 2.4154735 3.2437628 6.0000000 6.4679604 6.8207036 0.9668987 6.4679604
##  [8] 6.0000000 6.0774084 6.8207036 6.0774084 6.0000000 2.4154735 3.2437628
## [15] 0.9668987
\end{verbatim}
\begin{alltt}
  \hlstd{interm_energies} \hlkwb{=} \hlkwd{mapply}\hlstd{(coul_energy,charge_combos[,distances}\hlopt{>=}\hlnum{5}\hlstd{][}\hlnum{1}\hlstd{,],charge_combos[,distances}\hlopt{>=}\hlnum{5}\hlstd{][}\hlnum{2}\hlstd{,])}
...
\end{verbatim}
\begin{alltt}
  \hlstd{coul_energy} \hlkwb{=} \hlkwd{sum}\hlstd{(interm_energies)}
  \hlkwd{sprintf}\hlstd{(}\hlstr{"Total intermolecular Coulombic Energy is: %4.8f kcal/mol"}\hlstd{,}\hlkwd{sum}\hlstd{(interm_energies))}
\end{alltt}
\begin{verbatim}
## [1] "Total intermolecular Coulombic Energy is: 0.26909000 kcal/mol"
\end{verbatim}
\end{kframe}
\end{knitrout}

$$\text{Total Energy}=-0.6194387\ \text{kcal/mol}$$
\end{document}
