...
class TestDihedralForceField(unittest.TestCase):
    ...
    def test_get_ff_params_returns_correct_dihedral_forcefield_type(self):
        self.assertEqual(forcefield_class.get_ff_params(self.two_meoh_settings_file,4)[0],self.dih4_params[0],msg="The get_ff_params function of the forcefield class does not return the expected dihedral forcefield type")

    def test_get_ff_params_returns_correct_dihedral_parameters(self):
        self.assertEqual(forcefield_class.get_ff_params(self.two_meoh_settings_file,4)[1],self.dih4_params[1],msg="The get_ff_params function of the forcefield class does not return the expected dihedral parameters from the given settings file")

    def test_get_ff_function_returns_correct_forcefield_function(self):
        ff_function = forcefield_class.get_ff_function(self.two_meoh_settings_file,4)
    ...
    def test_read_ff_coeffs_return_correct_coeffs_from_settings_file(self):
        self.assertListEqual(forcefield_class.read_ff_coeffs(self.two_meoh_settings_file,'dihedral'),self.dih_coeffs,msg="The list of coefficients returned by read_ff_coeffs does not return the expected coefficients from the given settings file.")

    def test_initialize_dihedral_returns_expected_DihedralForceField_objects(self):
        dihedral_ffs = forcefield_class.initialize_dihedral_ffs(self.two_meoh_settings_file)
    ...
    def test_get_pdf_for_CCOH_dihedral_forcefield_returns_expected_cdf(self):
        ff = forcefield_class.DihedralForceField(self.two_meoh_settings_file,4)
